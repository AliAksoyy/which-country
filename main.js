...
btn.addEventListener("click", ()=> {
    ...
    contDiv.innerHTML = `
    <div><p class="score">Best Score: <span></span></p> </div>
    <div class="time">${timeCounter}</div>
    <div class="title">Choose the Country ? </div>
    <div> <span class="gamePoint">${gamePoint}</span> / <span class="gameCounter">${gameCounter}</span></div>
